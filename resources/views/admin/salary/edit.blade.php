		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-heading"><h3 class="panel-title">EDIT SALARY</h3>
						@if ($errors->any())
					...
					<div class="panel-body">
					      <form role="form" method="POST" action="{{ route('admin.salary.update',$salary->salary_id) }}">
                                @csrf
	                          <div class="form-group">
                                <label for="barber_id">Barber Name</label>
                                    ...
                                    <select class="form-control" name="barber_id">
                                        ...
                                        <option {{ $barber->id == $salary->salary_id ? 'selected' : '' }} value="{{ $barber->id }}">{{ $barber->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pay" name="pay" placeholder="Enter payment" value="{{ $salary->pay }}">
                                </div>

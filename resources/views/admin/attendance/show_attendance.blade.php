        ...
        <div class="row clearfix">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb pull-right">
                    <li><a href="{{-- {{ route('admin.appointment.index') }} --}}">attendance</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="radio" name="attendance[{{ $barber->id }}]" disabled="" value="Present" {{ $barber->attendance == 'Present' ? 'checked' : '' }}>Present
                                                <input type="radio" name="attendance[{{ $barber->id }}]" disabled="" value="Absent" {{ $barber->attendance == 'Absent' ? 'checked' : '' }}>Absent
